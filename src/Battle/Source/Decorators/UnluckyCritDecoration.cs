namespace Battle.Source.Decorators
{
    ...
    public class UnluckyCritDecoration(DecoratorPriority priority) : EntityParameterModuleDecorator(parameter: EntityParameter.CriticalChance, priority, "Unlucky_Crit_Decorator")
    {
