namespace Battle.Source.Decorators
{
    ...
    public class UnluckyChanceDecoration(DecoratorPriority priority, EntityParameter parameter) : EntityParameterModuleDecorator(parameter, priority, "Unlucky_Chance_Decorator")
    {
