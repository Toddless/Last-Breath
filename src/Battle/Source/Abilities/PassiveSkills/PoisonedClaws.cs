namespace Battle.Source.Abilities.PassiveSkills
{
    ...
    public class PoisonedClaws : Skill
    {
        ...
        public PoisonedClaws(float percentFormDamageToDealAsPoison, int poisonDuration, int stacks) : base(id: "Passive_Skill_Poisoned_Claws")
        {
            PercentToDealAsPoison = percentFormDamageToDealAsPoison;
            PoisonDuration = poisonDuration;
            PoisonStacks = stacks;
            _damageOverTurnEffect = new DamageOverTurnEffect(PoisonDuration, PoisonStacks, PercentToDealAsPoison);
        }
        ...
        private void OnAfterAttack(AfterAttackEvent obj)
        {
            ...
            var applyContext = new EffectApplyingContext { Caster = Owner, Target = target, Damage = damage, Source = this };
