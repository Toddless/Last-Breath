namespace LastBreath.Localization
{
    ...
    {
        [Export] public LocalizedString? OptionName { set; get; }
        [Export] public string TargetNode { get; set; } = string.Empty;
        [Export] public int RelationEffect { get; set; } = 0;
        [Export] public bool UsePlayerSource { get; set; } = true;
        [Export] public Array<Condition> Conditions { get; set; } = [];
