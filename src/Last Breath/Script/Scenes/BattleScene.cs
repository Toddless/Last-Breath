namespace Playground
{
	...
	public partial class BattleScene : Node2D
	{
		...
		private Button? _intelligenceStance;
		private Button? _strengthStance;
		private Button? _dexterityStance;
		private Button? _returnButton;
		private Button? _head;
		private Button? _body;
		private Button? _legs;
		...
		public override void _Ready()
		{
			...
			var attackButtons = battleSceneUi.GetNode("AttackButtons");
			var stanceButtons = attackButtons.GetNode("Stance");
			var bodyPartButtons = attackButtons.GetNode("BodyPart");
