namespace Crafting.Source.UIElements
{
    ...
    {
        [Signal]
        public delegate void LeftClickEventHandler(string id);

        [Signal]
        public delegate void RightClickEventHandler(string id, TreeItem item);

        [Signal]
        public delegate void CtrLeftClickEventHandler(string id, TreeItem item);
